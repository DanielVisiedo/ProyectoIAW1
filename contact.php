        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.1s">
                    <div class="bg-light rounded h-100 p-5">
                        <div class="section-title">
                            <h5 class="position-relative d-inline-block text-primary text-uppercase">Quien es tu profesional?</h5>
                            <h1 class="display-6 mb-4">Tabla de Profesionales</h1>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <i class="bi bi-geo-alt fs-1 text-primary me-3"></i>
                            <div class="text-start">
                                <h5 class="mb-0">Nuestros Profesionales</h5>
                                <span>1 - Sara Camon <br> 2 - Jorge Hernandez <br> 3 - Alex Elcapo <br> 4 - Loulogio Elbatas <br> 5 - Joe Mama</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>1 - Normal <br> 2 - Urgente <br> 3 - Larga <br> 4 - Corta</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control border-0 bg-light px-4" placeholder="Psicologo" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" rows="5" placeholder="Mensaje"></textarea>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit">Buscar</button>
                            </div>
                        </div>
                    </form>
                </div>
                <h1>Todas tus citas</h1>
                    ...
                    $id=$_SESSION['id_usu'];
                    $sql = "select * from citas where id_usu=$id";
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='contact.php? id=" .$row['id']. "'/a>Modify</td>";
                        echo "</tr>";
                        }
                    }
                    echo "</table>";
